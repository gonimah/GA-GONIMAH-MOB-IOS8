...
class ArrayTableViewController: UITableViewController {
    ...
    */
    let animalArray = [Unicorn(name: "Rover"), Unicorn(name: "Mittens"), Unicorn(name: "Ein"), Unicorn(name: "Sadie")]
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("animals") ?? UITableViewCell(style: .Default, reuseIdentifier: "animals")
